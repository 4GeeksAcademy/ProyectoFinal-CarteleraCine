            ...
            <div className="container">
                <div className="row mt-5" key={movie.id}>
                    ...
                    <div className="col-8 mt-5 mb-5">
                        ...
                        <p className="rounded-circle text-white d-flex justify-content-center align-items-center fs-3" style={{width: "70px", height: "70px", backgroundColor: "#2a80a0"}}>{movie.rating}</p>
                        <h5>Descripción</h5>
                        <p>{movie.overview}</p>
                    </div>
                    <div className="">
                        <div>
                            <button className="btn p-3 mb-1 d-grid gap-2 col-12 mx-auto text-white" style={{backgroundColor: "#2a80a0"}} type="button" data-bs-toggle="collapse" data-bs-target="#paseo" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div>
                            <button className="btn p-3 mb-1 d-grid gap-2 col-12 mx-auto text-white" style={{backgroundColor: "#2a80a0"}} type="button" data-bs-toggle="collapse" data-bs-target="#oxigeno" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div>
                            <button className="btn p-3 mb-1 d-grid gap-2 col-12 mx-auto text-white" style={{backgroundColor: "#2a80a0"}} type="button" data-bs-toggle="collapse" data-bs-target="#molinos" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div>
                            <button className="btn p-3 mb-1 d-grid gap-2 col-12 mx-auto text-white" style={{backgroundColor: "#2a80a0"}} type="button" data-bs-toggle="collapse" data-bs-target="#santaFe" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div>
                            <button className="btn p-3 mb-1 d-grid gap-2 col-12 mx-auto text-white" style={{backgroundColor: "#2a80a0"}} type="button" data-bs-toggle="collapse" data-bs-target="#florida" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div>
                            <button className="btn p-3 mb-1 d-grid gap-2 col-12 mx-auto text-white" style={{backgroundColor: "#2a80a0"}} type="button" data-bs-toggle="collapse" data-bs-target="#aventura" aria-expanded="false" aria-controls="collapseExample">
