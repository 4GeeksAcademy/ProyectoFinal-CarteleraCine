            ...
            <div className="container">
                <div className="row mt-5" key={movie.id}>
                    ...
                    <div className="col-8 mt-5 mb-5">
                        ...
                        <p className="rounded-circle  text-white d-flex justify-content-center align-items-center fs-4" style={{backgroundColor: '#0d6efd', color: '#ffffff', border: '2px solid #ffffff' , width: "70px", height: "70px"}}>{movie.rating}</p>
                        <h5>Descripción</h5>
                        <p>{movie.overview}</p>
                    </div>
                    <div className="">
